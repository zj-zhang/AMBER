...
class Amber:
    ...
    def from_dict(self, d):
        ...
        self.reward_fn = _getter.get_reward_fn(reward_fn_type=self.type_dict['reward_fn_type'],
                                               knowledge_fn=self.knowledge_fn,
                                               **d['reward_fn'])

        self.manager = _getter.get_manager(manager_type=self.type_dict['manager_type'],
        ...
        self.env = _getter.get_train_env(env_type=self.type_dict['env_type'],
                                         controller=self.controller,

...
def main():
    ...
    if args.analysis == "train":
        meta, dfeatures, model_space, controller = prep(args.wd, is_training=True)
        custom_train(controller, args.wd)
    else:
        meta, dfeatures, model_space, controller = prep(args.wd, is_training=False)
